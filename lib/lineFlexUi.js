  ...
  const contents = makeBubble({
    ...
    bodyContents: [
      ...
      stepCard(2, 'เปิดรับการแจ้งเตือนผลเทรด', [
        ...
        '✅ รับสรุปอัตโนมัติ 07:00 น. (จ–พฤ และวันเสาร์สำหรับสรุปวันศุกร์)',
    ...
    bodyContents: [
      ...
      },
      {
        ...
        text: isRegister
          ...
          : 'พิมพ์ Email แล้วระบบจะส่งสรุปเวลา 07:00 น. (จ–พฤ และวันเสาร์สำหรับสรุปวันศุกร์)',
        size: 'xs',
        color: C_MUTED,
        align: 'center',
        wrap: true,
    ...
    bodyContents: [
      {
        ...
        contents: [
          ...
          {
            type: 'text',
            text: 'ทุกวัน 07:00 น. (จันทร์–พฤหัส และวันเสาร์สำหรับสรุปวันศุกร์)\nครอบคลุมทุก Port ที่เปิดใช้งาน',
            size: 'xs',
            color: '#555555',
            wrap: true,
            margin: 'sm'
  ...
  const bodyContents = [
    {
      ...
      contents: [
        ...
        {
          type: 'text',
          text: '🌅 ส่งอัตโนมัติ 07:00 น. (จ–พฤ และวันเสาร์สำหรับสรุปวันศุกร์)',
          size: 'xs',
          color: '#555555',
          margin: 'md',
          wrap: true
