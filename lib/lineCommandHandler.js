...
function manualText() {
  return [
    '📖 วิธีใช้งาน Avelqua LINE',
    '─'.repeat(28),
    '1️⃣ แจ้งสรุปผล',
    '   กดปุ่ม → ระบุ Email ที่สมัครเว็บ',
    '   รับสรุปกำไร/ขาดทุนทุกวัน 07:00 น.',
    '   (จันทร์–ศุกร์)',
    '',
    '2️⃣ เช็คพอร์ต',
    '   ดู P&L ทุกพอร์ตที่เปิดใช้',
    '   พร้อมสถานะ MT5 และบอท',
    '',
    '3️⃣ ลงทะเบียน',
    '   ผูก LINE กับบัญชีเว็บด้วย Email',
    '',
    '💡 ใช้ Email เดียวกับที่สมัคร trading.avelqua.com'
  ].join('\n');
}
