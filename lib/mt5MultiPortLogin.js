...
/**
 * ดีเลย์ก่อนเปิด MT5 (เฉพาะ login) — เรียงตาม FolderPort น้อยก่อน ห่างกันละ 15 วินาที (ค่าเริ่มต้น)
 * ตัวอย่าง PORT-02 = 0s, PORT-04 = 15s, PORT-05 = 30s
 */
async function computeLoginQueueDelaySec(vpsId, accountId = 0, assignedPortNo = 0) {
  ...
  const stagger = Math.max(1, num(process.env.MT5_LOGIN_QUEUE_STAGGER_SEC, 15));
