...
async function queueStopMt5ForAccount(accountId, opts = {}) {
  ...
  portNo = normalizeSystemFolderPortNo(portNo);
  ...
  const pl = {
    ...
    folderPort: portNo || undefined,
    vpsPortNumber: portNo || undefined,
    folder_path: folderPath,
    folderPath,
    vpsFolderPath: folderPath,
    accountId,
  ...
  if (portNo) {
    const { payloadFolderPortSql } = require('./mt5ReservedPortNo');
