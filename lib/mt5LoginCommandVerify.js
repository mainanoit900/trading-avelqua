...
const { parseMt5JournalOutcome, MT5_SUCCESS_MSG, MT5_EARLY_SUCCESS_MSG, MT5_FAIL_USER_MSG } = require('./mt5JournalVerify');
const {
...
async function tryFastConnectConfirm(account) {
  ...
  if (loginJournal) {
    return promoteConnected('login_cmd_journal', MT5_EARLY_SUCCESS_MSG);
  }
...
const JOURNAL_QUEUE_MIN_INTERVAL_SEC = Number(
  process.env.MT5_JOURNAL_QUEUE_MIN_INTERVAL_SEC || 25
);
