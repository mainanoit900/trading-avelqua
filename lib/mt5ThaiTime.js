...
function isWeekendDayKey(dayKey) {
  ...
  const dow = weekdayBangkok(new Date(`${key}T12:00:00+07:00`));
  return dow === 0 || dow === 6;
}

function isMarketOpenBangkok(value = new Date()) {
  return !isWeekendDayKey(dayKeyBangkok(value));
}
