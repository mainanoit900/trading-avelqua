...
const { loadEaMeta } = require('./mt5EaLicense');
...
const EA_DEFAULTS_BY_SLUG = {
  ...
  'sniper-demo': { pip_step: 345, take_profit_average: 100, cut_loss_pct: 100, magic_number: 2122025, soft_close: 0 }
};
...
function eaDefaultsForSlug(presetSlug) {
  ...
  const meta = loadEaMeta(slug);
  const fromMeta = meta?.set_only_defaults || {};
