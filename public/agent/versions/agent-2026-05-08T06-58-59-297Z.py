...
'''
    ...
    while time.time() < deadline:
        ...
        auth_ok = (
                "authorized on" in raw_text.lower()
                or "previous successful authorization" in raw_text.lower()
                or "terminal synchronized" in raw_text.lower()
                or "trading has been enabled" in raw_text.lower()
        )
