...
"""
    ...
    while time.time() < deadline:
        ...
        auth_ok = (
            "authorized on" in latest_text
            or "previous successful authorization" in latest_text
            or "terminal synchronized" in latest_text
            or "trading has been enabled" in latest_text
        )
